...
const supportedDiagram = {
    kroki: {
        ...
        matchRegexp: /(\s*)(```) *(blockdiag|bpmn|seqdiag|actdiag|nwdiag|packetdiag|rackdiag|c4plantuml|ditaa|erd|excalidraw|graphviz|mermaid|nomnoml|pikchr|puml|plantuml|svgbob|vegalite|vega|wavedrom) *\n?([\s\S]+?)\s*(\2)(\n+|$)/g,
        diagTypes: [
            "blockdiag",
            "bpmn",
            "bytefield",
